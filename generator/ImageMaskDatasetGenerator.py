...
class ImageMaskDatasetGenerator:
  ...
  def augment(self, image, output_dir, filename):
    ...
    for resize in SHRINKS:
      ...
      output_filename = "shrinked_" + ratio + "_" + filename
...
if __name__ == "__main__":
  try:
   ...
   images_output_dir = "./Skin-Lesion/train/images/"
   masks_output_dir  = "./Skin-Lesion/train/masks/"
   ...
   images_output_dir = "./Skin-Lesion/valid/images/"
   masks_output_dir  = "./Skin-Lesion/valid/masks/"
   generator.generate(input_images_dir, input_masks_dir, 
   					  images_output_dir, masks_output_dir)
   ...
   images_output_dir = "./Skin-Lesion/test/images/"
   masks_output_dir  = "./Skin-Lesion/test/masks/"
   generator.generate(input_images_dir, input_masks_dir, 
